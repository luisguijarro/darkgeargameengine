...
namespace dge.G2D
{    
    internal class IDsDrawerGL : I_IDsDrawer
    {
        ...
        public IDsDrawerGL()
        {
            ...
            */
            ...
            BasicShader = new Shader(ShadersSources.Basic2Dvs, ShadersSources.Basic2Dfs, false);
            ...
            BasicGuiShader = new Shader(ShadersSources.BasicGUIvs, ShadersSources.BasicGUIfs, false);

            idUniform_texcoords2 = GL.glGetUniformLocation(BasicGuiShader.ID, "utexcoords");
            idUniform_MarginsFromTheEdge2 = GL.glGetUniformLocation(BasicGuiShader.ID, "MarginsFromTheEdge");
            idUniform_v_size2 = GL.glGetUniformLocation(BasicGuiShader.ID, "v_size");
            idUniformTColor2 = GL.glGetUniformLocation(BasicGuiShader.ID, "tColor");
            idUniformColor2 = GL.glGetUniformLocation(BasicGuiShader.ID, "Color");
            idUniformMat_View2 = GL.glGetUniformLocation(BasicGuiShader.ID, "view");
            idUniformMat_Per2 = GL.glGetUniformLocation(BasicGuiShader.ID, "perspective");
            idUniformMat_Tra2 = GL.glGetUniformLocation(BasicGuiShader.ID, "trasform");
            idUniformSilhouette2 = GL.glGetUniformLocation(BasicGuiShader.ID, "Silhouette");
            idUniformTexturePassed2 = GL.glGetUniformLocation(BasicGuiShader.ID, "TexturePassed");
            idUniformtcDisplacement2 = GL.glGetUniformLocation(BasicGuiShader.ID, "tcDisplacement");
